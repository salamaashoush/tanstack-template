 ...
 */
interface LanguagePriority<T extends string = string> {
  /**
...
function byQuality(a: LanguagePriority, b: LanguagePriority) {
  return b.quality - a.quality;
}

function bySpecificity(a: LanguagePriority, b: LanguagePriority) {
  return (
